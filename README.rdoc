...
GIT clone https://github.com/goodbye-island/S-Store-backend.git
Step 2:
...
Step 5:
Create a database.yml file in the config folder under the root folder of the project and configure it tok point at your database
Step 6:
either run the file
backendnewhahagetit.bat
or run the command 
rails server -b 0.0.0.0 -p 8080
Step 7: Verify the server starts correctly by visiting one of the routes
try
localhost:8080/class_view?
in your browser
